        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-row gap-x-5 items-center">
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                ...
                                <h3 class="text-teal-950 text-xl font-bold">Rp 0</h3>
                            </div>
                    </div>
                </div>
            ...
            <div class="flex flex-row gap-x-10">
                <div>
                    ...
                    <h3 class="text-teal-950 text-xl font-bold">Angga Capital</h3>
                </div>
                <div>
                    <p class="text-slate-500 text-sm">No Account</p>
                    <h3 class="text-teal-950 text-xl font-bold">08123092093</h3>
                </div>
                <div>
                    <p class="text-slate-500 text-sm">Account Name</p>
                    <h3 class="text-teal-950 text-xl font-bold">BenefitPost Brand</h3>
                </div>
            </div>
                ...
                <h3 class="text-teal-950 text-xl font-bold">Confirm Topup Wallet</h3>
