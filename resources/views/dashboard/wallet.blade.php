    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between items-center">
                    ...
                    <div class="flex flex-row gap-x-5">
                        ...
                        <a href="{{ route('dashboard.wallet.withdraw') }}"
                            class="font-bold py-4 px-6 bg-teal-700 text-white rounded-full">
                            Request Withdraw
                        </a>
                ...
                <hr class="my-5">
                <h3 class="text-teal-950 text-xl font-bold">Latest Transactions</h3>
                    ...
                    <div class="flex flex-row  justify-between items-center">
                        <div class="flex flex-row gap-x-5">
                            ...
                            <div>
                                ...
                                <h3 class="text-teal-950 text-xl font-bold">Rp {{ number_format($transaction->amount, 0, ',','.' ) }}</h3>
                            </div>
                        </div>

                        <div class="">
                            <p class="text-slate-500 text-sm">{{ $transaction->type }}</p>
                            <h3 class="text-teal-950 text-xl font-bold">Topup</h3>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 class="text-teal-950 text-xl font-bold">
                                {{ $transaction->created_at->format('M d, Y') }}</h3>
                        </div>
                    </div>
                @empty
                    <p>Belum ada data transaksi terbaru</p>
                @endforelse ($wallet_transactions as $transaction)
