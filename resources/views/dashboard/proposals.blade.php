                ...
                <div class="item-card flex flex-col md:flex-row gap-y-10 justify-between md:items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-teal-950 text-xl font-bold">{{ $proposal->project->name }}</h3>
                    ...
                    <div class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-teal-950 text-xl font-bold">Rp {{ number_format($proposal->project->budget, 0, ',','.' )}}</h3>
                    </div>

                    <div class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Applied at</p>
                        <h3 class="text-teal-950 text-xl font-bold">{{ $proposal->created_at->format('D m y') }}</h3>
                    </div>

                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('dashboard.proposal_details', [$proposal->project, $proposal->id]) }}" class="font-bold py-4 px-6 bg-teal-700 text-white rounded-full">
                            Details
                        </a>
                    </div>
                </div>
