<x-app-layout>
    ...
    <section id="details" class="container mx-auto my-2 flex flex-col sm:flex-row sm:flex-nowrap gap-5 mt-[30px] w-full max-w-[1130px]">
        <div class="bg-white w-screen flex flex-col gap-5 p-5 rounded-[20px]">
    ...
    <section id="other" class="container max-w-[1130px] mx-auto flex flex-col gap-4 mt-[50px]">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-5">
            ...
            <a href="{{ route('front.details', $project) }}" class="card">
                <div class="p-5 rounded-[20px] bg-white flex my-4 flex-col gap-5 hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
