<x-app-layout>
    ...
    <div class="max-w-screen-xl mt-10 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex flex-row gap-x-5 items-center">
                    <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            <h3 class="text-teal-950 text-xl font-bold">Rp {{number_format(Auth::user()->wallet->balance, 0, ',','.' )  }}</h3>
                        </div>
                </div>
                <a href="{{ route('dashboard.wallet.topup') }}" class="font-bold py-4 px-6 bg-teal-700 text-white rounded-full">
                    Topup Wallet
                </a>
            </div>
        ...
        <div class="max-w-screen-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <x-input-label for="about" :value="__('Descrpition')" />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="requirement" id="requirement" cols="30" rows="5" class="border border-slate-300 rounded-xl w-full"></textarea>
