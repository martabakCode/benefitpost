            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-teal-950 text-xl font-bold">{{ $transaction->created_at->format('M d, Y') }}</h3>
                    </div>
                    <div class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">User</p>
                        <h3 class="text-teal-950 text-xl font-bold">{{ $transaction->user->name}}</h3>
                    </div>
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.wallet_transactions.show', $transaction) }}" class="font-bold py-4 px-6 bg-teal-700 text-white rounded-full">
                            View Details
                        </a>
                    </div>
                </div>
